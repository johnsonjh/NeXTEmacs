...
/* Nonzero means last display completed and cursor is really at cursor_hpos, cursor_vpos.
      ...
      if (current_screen->enable[vpos] && new_screen->enable[vpos])
	{
	  ...
	  if (current_screen->used[vpos] > end
		...
		new_screen->contents[vpos][new_screen->used[vpos]++] = ' ';
	      bcopy (current_screen->contents + end,
		     new_screen->contents + end,
